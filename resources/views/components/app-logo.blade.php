<div class="flex items-center hidden sm:block">
    <img 
        ...
        alt="Logo" 
        class="w-20 h-18 mix-blend-multiply dark:mix-blend-screen dark:opacity-90 transition-all duration-200"
    >
...
<div class="flex items-center sm:hidden">
    <img 
        src="{{ asset('logos/no-bg-logo.png') }}" 
        alt="Logo" 
        class="w-16 h-16 mix-blend-multiply dark:mix-blend-screen dark:opacity-90 transition-all duration-200"
    >
</div>
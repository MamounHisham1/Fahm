    ...
    <div class="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-2 border border-gray-200 dark:border-gray-700">
                <img src="https://placehold.co/600x400/e2e8f0/475569?text=Our+Team" alt="Our Team" class="rounded-lg w-full">
            </div>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Trust & Privacy</h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Accessibility</h3>
                    <p class="text-gray-600 dark:text-gray-300">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Passion for Education</h3>
                    <p class="text-gray-600 dark:text-gray-300">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="aspect-w-1 aspect-h-1 bg-gray-200 dark:bg-gray-700">
                    <img src="https://placehold.co/400x400/e2e8f0/475569?text=CEO" alt="CEO" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Alex Morgan</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">CEO & Co-Founder</p>
                    <p class="text-gray-600 dark:text-gray-300 text-sm">Former teacher with 10+ years of experience in EdTech.</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="aspect-w-1 aspect-h-1 bg-gray-200 dark:bg-gray-700">
                    <img src="https://placehold.co/400x400/e2e8f0/475569?text=CTO" alt="CTO" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Jamie Chen</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">CTO & Co-Founder</p>
                    <p class="text-gray-600 dark:text-gray-300 text-sm">Software engineer passionate about using technology to solve educational challenges.</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="aspect-w-1 aspect-h-1 bg-gray-200 dark:bg-gray-700">
                    <img src="https://placehold.co/400x400/e2e8f0/475569?text=CPO" alt="CPO" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Taylor Williams</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">Chief Product Officer</p>
                    <p class="text-gray-600 dark:text-gray-300 text-sm">Former curriculum designer with expertise in learning experience design.</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="aspect-w-1 aspect-h-1 bg-gray-200 dark:bg-gray-700">
                    <img src="https://placehold.co/400x400/e2e8f0/475569?text=CMO" alt="CMO" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Jordan Patel</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">Chief Marketing Officer</p>
                    <p class="text-gray-600 dark:text-gray-300 text-sm">Experienced in building brands that resonate with educators and schools.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-50 dark:bg-gray-900 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Backed By</h2>
                <p class="text-xl text-gray-600 dark:text-gray-300">
                    Partners who believe in our mission
                </p>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <span class="text-xl font-bold text-gray-400">Investor 1</span>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <span class="text-xl font-bold text-gray-400">Investor 2</span>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <span class="text-xl font-bold text-gray-400">Investor 3</span>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm flex items-center justify-center h-24">
                    <span class="text-xl font-bold text-gray-400">Investor 4</span>
                </div>
            </div>
        </div>
    </div>

        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="subject" class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Subject</label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" rows="5" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"></textarea>
                    </div>
                    
                    <div class="flex items-start">
                        <input type="checkbox" name="privacy" id="privacy" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 mt-1">
                        <label for="privacy" class="ml-2 block text-sm text-gray-600 dark:text-gray-400">
                            I agree to the <a href="#" class="text-blue-600 hover:text-blue-500 dark:text-blue-400">privacy policy</a> and understand that my information will be processed as described.
                        </label>
                    </div>
                ...
                <div class="space-y-8">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Mon-Fri from 8am to 6pm EST</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-gray-600 dark:text-gray-300">support@example.com</p>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">We aim to respond within 24 hours</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Come visit us during business hours</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-gray-50 dark:bg-gray-900 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Visit our office</h2>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="h-96 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                    <p class="text-gray-500 dark:text-gray-400">Map placeholder - embed Google Maps here</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="space-y-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">How quickly can I expect a response?</h3>
                <p class="text-gray-600 dark:text-gray-300">We aim to respond to all inquiries within 24 hours during business days. For urgent matters, please call our support line.</p>
            </div>
            
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">Do you offer technical support by phone?</h3>
                <p class="text-gray-600 dark:text-gray-300">Yes, our technical support team is available by phone Monday through Friday from 8am to 6pm EST. You can reach them at the number listed above.</p>
            </div>
            
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-3">How can I schedule a demo?</h3>
                <p class="text-gray-600 dark:text-gray-300">You can schedule a demo by filling out the contact form above and selecting "Request a Demo" from the subject dropdown. One of our representatives will reach out to arrange a time.</p>
            </div>
        </div>
    </div>

<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sticky top-4 max-h-[calc(100vh-2rem)] overflow-y-auto">
                            ...
                            <div class="flex flex-col">
                                <div class="flex items-center justify-between">
                                    ...
                                    @if (route('client.lessons.show', ['subject' => $subject, 'lesson' => $lesson]) == request()->url())
                                        <span
                                            class="text-xs px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 dark:bg-indigo-900/60 dark:text-indigo-300 font-medium">
                                            Current
                                        </span>
                                    @elseif($lesson->views()->where('user_id', Auth::user()->id)->exists())
                                        <span
                                            class="text-xs px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300 font-medium">
                                            Viewed
                                        </span>
                                    @endif
                                </div>
        ...
        <div class="lg:col-span-3">
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-xl font-bold text-gray-900 dark:text-white">{{ $selectedLesson->title }}
                            </h2>
                        </div>
                        ...
                        <div class="flex items-center gap-4 mb-6 text-sm text-gray-500 dark:text-gray-400">
                            <div class="flex items-center">
                                <div
                                    class="w-6 h-6 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 mr-2">
            ...
            @else
                <div
                    class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center h-full flex items-center justify-center">
                    <div>
                        <div
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">{{ __('Select a lesson') }}
                        </h3>

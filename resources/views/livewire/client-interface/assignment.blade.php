<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 gap-6">
        @forelse($assignments as $assignment)
            <a 
                href="{{ route('client.assignments.show', $assignment->id) }}"
                wire:navigate
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1">{{ $assignment->due_date ? $assignment->due_date->format('M d, Y - h:i A') : __('No due date') }}</span>
                            </div>
                            <div class="flex items-center">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-white bg-blue-600 group-hover:bg-blue-700 transition-colors">
                            {{ __('View Assignment') }}
        ...
        @empty
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-6">{{ __('No assignments match your current filters.') }}</p>

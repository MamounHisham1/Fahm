                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" wire:navigate class="text-sm text-blue-600 hover:underline absolute end-0 top-0">
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <label for="remember" class="ml-2 text-sm font-medium text-gray-600">
                                    {{ __('Remember me') }}
                                </label>
                            </div>
                        </div>
